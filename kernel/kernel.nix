...
let
  ...
  patchedSrc = pkgs.applyPatches {
    ...
    postPatch = ''
      ...
      grep -q 'MPSC' arch/x86/Kconfig.cpu || { echo "ERROR: X86_L1_CACHE_SHIFT hand-fix did not apply"; exit 1; }
      grep -q 'MK8 || MK7 || MCORE2 || MPENTIUM4' arch/x86/Kconfig.cpu || { echo "ERROR: X86_CMOV hand-fix did not apply"; exit 1; }
      grep -q 'MATOM || MCORE2 || MK7 || MK8' arch/x86/Kconfig.cpu || { echo "ERROR: X86_MINIMUM_CPU_FAMILY hand-fix did not apply"; exit 1; }
    '';
  };
in
